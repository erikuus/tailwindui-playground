...
- Kuigi enamik `pages` ja `components` malle on sisult VAU-spetsiifilised, saab sisu eemaldades või asendades kätte **hästi töötavad responsiivsed “konteinerid”** (küljendused).
